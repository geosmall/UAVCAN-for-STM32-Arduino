...
# img = open("C:/Users/geoma/Desktop/build/libcanard_example.ino.bin", 'rb').read()
filepath = Path(__file__).parent / "../../../build/libcanard_example.ino.bin"
print(filepath)
...
# open("C:/Users/geoma/Desktop/build/libcanard_example.ino_magic.bin", 'wb').write(img)
filepath = Path(__file__).parent / "../../../build/libcanard_example.ino_magic.bin"
print(filepath)
