...
It has been tested on STM32F103C8 development board, using Arduino IDE v1.8.5 with Arduino Core STM32 v1.4.0.  CAN bus commands were generated using UAVCAN GUI (https://uavcan.org/GUI_Tool/Overview/) v0.9.0 (from here https://files.zubax.com/products/org.uavcan.gui_tool/) running on 64 bit Win 10.
